...
void main() => runApp(const AcceptedOrders());
...
class _AcceptedOrdersState extends State<AcceptedOrders> {
  ...
  Future<void> deliverCancel() async {
    return showDialog(
        context: context,
  ...
  Future<void> confirmDeliverAlert(int id) async {
    return showDialog(
        context: context,
        barrierDismissible: false,
        builder: (BuildContext context) {
  ...
  Future<void> confirmCancelAlert(int id) async {
    return showDialog(
        context: context,
        barrierDismissible: false,
        builder: (BuildContext context) {
          return AlertDialog(
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.all(Radius.circular(30.0))),
            title: Text(
              'Are you sure you want to cancel this order delivery?',
            ),
            actions: <Widget>[
              ElevatedButton(
                style: ButtonStyle(
